...
For easy setup and deployment, we provide an [all-in-one image](https://hub.docker.com/r/lowcoderorg/lowcoder-ce) that bundles frontend, backend, and data persistence services altogether in one single container. TODO https://lowcoder.cloud/images/Screenshot-2023-08-27-at-21.50.36.png
...
Docker-Compose (Recommended) Follow the steps below:
...
Docker-Compose Run the following commands to update to the latest Lowcoder image:
...
Docker Run the following commands to update to the latest Lowcoder image:
...
TODO https://lowcoder.cloud/images/Screenshot-2023-08-27-at-21.56.51.png Multi-Image Installation to scale. API-Service & Node-Service can get scaled independently.
...
Docker-Compose Add environment variables `MONGODB_URI` and `REDIS_URI` in `docker-compose.yml` downloaded in your working directory.\\

Docker Add environment variables `MONGODB_URI` and `REDIS_URI` to the deployment command, as shown below:
...
Docker-Compose Add an environment variable `LOCAL_USER_ID` in `docker-compose.yml` downloaded in your working directory.\\

Docker Add an environment variable `LOCAL_USER_ID` to the deployment command, as shown below:
